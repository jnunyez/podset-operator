...
import (
	...
	niceesv1alpha1 "github/jnunyez/podset-operator/api/v1alpha1"
...
//+kubebuilder:rbac:groups=nice.es,resources=podsets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=nice.es,resources=podsets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=nice.es,resources=podsets/finalizers,verbs=update
...
func (r *PodSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	instance := &niceesv1alpha1.PodSet{}
	...
	status := niceesv1alpha1.PodSetStatus{
...
func newPodForCR(cr *niceesv1alpha1.PodSet) *corev1.Pod {
